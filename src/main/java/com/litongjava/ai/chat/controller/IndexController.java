...
public class IndexController {
  ...
  private String getHtml(AuthService authService, UserInfo userInfo, Map<String, Object[]> query, String remoteIp,
      String fileName) {
    // 构建 propsValue
    ...
    String jsonString = JSON.toJSONString(propsValue);
